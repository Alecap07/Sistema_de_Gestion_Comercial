...
import { MdControlPoint, MdOutlineProductionQuantityLimits  } from "react-icons/md";
    ...
    <div className="nav-bg">
      <nav className="nav-glass">
        ...
        <ul className="nav-links-top">
          <NavItem to="/productos" icon={<MdOutlineProductionQuantityLimits />} text="Productos" />
          <NavItem to="/categorias" icon={<FaProjectDiagram />} text="Categorias" />
          <NavItem to="/marcas" icon={<TbBrandAdonisJs />} text="Marcas" />
        ...
        <ul className="nav-links-mobile">
          <NavItemMobile to="/productos" icon={<MdOutlineProductionQuantityLimits />}  />
          <NavItemMobile to="/categorias" icon={<FaProjectDiagram />} />
          <NavItemMobile to="/marcas" icon={<TbBrandAdonisJs />}  />
          <li>
            <button

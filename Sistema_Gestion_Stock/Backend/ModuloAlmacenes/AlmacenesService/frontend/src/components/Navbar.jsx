    ...
    <div className="nav-bg">
      <nav className="nav-glass">
        ...
        <ul className="nav-links-top">
          <NavItem to="/" icon={<BsBoxSeam />} text="Productos" />
          <NavItem to="/movimientos" icon={<GiHandTruck />} text="Movimientos" />
          <NavItem to="/scrap" icon={<IoBan />} text="Scrap" /> {/* 👈 Nueva sección */}
        ...
        <ul className="nav-links-mobile">
          ...
          <NavItemMobile to="/scrap" icon={<IoBan />} /> {/* 👈 Mobile Scrap */}
          <li>
            <button
